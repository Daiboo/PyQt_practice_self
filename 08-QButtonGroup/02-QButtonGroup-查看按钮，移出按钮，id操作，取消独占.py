...
sex_group.addButton(rb_male,1)  # 1 为设置的id,默认为-1 系统会自动分配
sex_group.addButton(rb_female,2) #
sex_group.removeButton(rb_female)  # 从组中移出按钮
...
answer_group.setId(rb_yes,1)  # 除了在addButton时设置id,也可以独立设置
...
print(sex_group.button(2))  # sex_group中id=2的按钮
