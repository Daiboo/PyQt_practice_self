...
class Window(QWidget):
    ...
    def setup_ui(self):
        ...
        # pte.textChanged.connect(lambda:print("内容法伤改变"))
        # pte.selectionChanged.connect(lambda:print("选中发生改变",pte.textCursor().selectedText()))
        # pte.modificationChanged.connect(lambda val: print("修改状态发生改变",val))
        # pte.cursorPositionChanged.connect(lambda val : print("光标位置发生改变",val))
        # pte.blockCountChanged.connect(lambda bc:print("块的个数发生改变",bc))
